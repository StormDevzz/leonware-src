...
/* JADX INFO: loaded from: leonware-0.0.3.jar:sweetie/leonware/client/features/modules/render/custommodel/AmogusFeatureRenderer.class */
@Environment(EnvType.CLIENT)
public class AmogusFeatureRenderer extends class_3887<class_10055, class_591> {
    private static final class_2960 AMOGUS_TEXTURE = class_2960.method_60655("leonware", "textures/models/leon/amogus.png");
    ...
    public void method_4199(class_4587 matrices, class_4597 vertexConsumers, int light, class_10055 state, float limbAngle, float limbDistance) {
        if (shouldRender(state)) {
            this.amogusModel.copyPoseFromBase((class_591) method_17165());
            matrices.method_22903();
            if (state.field_53457) {
                matrices.method_22905(0.5f, 0.5f, 0.5f);
                matrices.method_46416(0.0f, 1.5f, 0.0f);
            } else {
                matrices.method_22904(0.0d, -0.8d, 0.0d);
                matrices.method_22905(1.8f, 1.6f, 1.6f);
            }
            class_4588 buffer = vertexConsumers.getBuffer(class_1921.method_23578(AMOGUS_TEXTURE));
