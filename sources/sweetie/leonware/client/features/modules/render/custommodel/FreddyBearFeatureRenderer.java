...
/* JADX INFO: loaded from: leonware-0.0.3.jar:sweetie/leonware/client/features/modules/render/custommodel/FreddyBearFeatureRenderer.class */
@Environment(EnvType.CLIENT)
public class FreddyBearFeatureRenderer extends class_3887<class_10055, class_591> {
    private static final class_2960 FREDDY_TEXTURE = class_2960.method_60655("leonware", "textures/models/leon/freddy.png");
    ...
    public void method_4199(class_4587 matrices, class_4597 vertexConsumers, int light, class_10055 state, float limbAngle, float limbDistance) {
        if (shouldRender(state)) {
            this.freddyModel.copyPoseFromBase((class_591) method_17165());
            matrices.method_22903();
            matrices.method_22905(0.75f, 0.65f, 0.75f);
            matrices.method_46416(0.0f, 0.85f, 0.0f);
            class_4588 buffer = vertexConsumers.getBuffer(class_1921.method_23578(FREDDY_TEXTURE));
