...
/* JADX INFO: loaded from: leonware-0.0.3.jar:sweetie/leonware/api/event/events/player/move/MotionEvent.class */
public class MotionEvent extends Event<MotionEventData> {
    ...
    /* JADX INFO: loaded from: leonware-0.0.3.jar:sweetie/leonware/api/event/events/player/move/MotionEvent$MotionEventData.class */
