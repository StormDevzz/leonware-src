...
/* JADX INFO: loaded from: leonware-0.0.3.jar:sweetie/leonware/api/event/events/player/move/VelocityEvent.class */
public class VelocityEvent extends Event<VelocityEventData> {
    ...
    /* JADX INFO: loaded from: leonware-0.0.3.jar:sweetie/leonware/api/event/events/player/move/VelocityEvent$VelocityEventData.class */
