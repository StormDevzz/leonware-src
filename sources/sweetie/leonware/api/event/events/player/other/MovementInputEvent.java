...
/* JADX INFO: loaded from: leonware-0.0.3.jar:sweetie/leonware/api/event/events/player/other/MovementInputEvent.class */
public class MovementInputEvent extends Event<MovementInputEventData> {
    ...
    /* JADX INFO: loaded from: leonware-0.0.3.jar:sweetie/leonware/api/event/events/player/other/MovementInputEvent$MovementInputEventData.class */
