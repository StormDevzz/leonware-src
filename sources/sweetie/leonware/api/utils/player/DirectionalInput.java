...
/* JADX INFO: loaded from: leonware-0.0.3.jar:sweetie/leonware/api/utils/player/DirectionalInput.class */
public final class DirectionalInput {
    ...
    public int hashCode() {
        ...
        return (31 * ((31 * ((31 * result) + Boolean.hashCode(this.backwards))) + Boolean.hashCode(this.left))) + Boolean.hashCode(this.right);
    }
