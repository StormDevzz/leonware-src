...
/* JADX INFO: loaded from: leonware-0.0.3.jar:sweetie/leonware/api/utils/render/display/GlowRectRender.class */
public class GlowRectRender implements QuickImports {
    ...
    public void draw(class_4587 matrices, float x, float y, float width, float height, float radius, Color color, float glowSize, float glowIntensity) {
        draw(matrices, x, y, width, height, new Vector4f(radius, radius, radius, radius), color, color, color, color, glowSize, glowIntensity, 1.0f);
    }
    ...
    public void draw(class_4587 matrices, float x, float y, float width, float height, Vector4f radius, Color topLeft, Color topRight, Color bottomLeft, Color bottomRight, float glowSize, float glowIntensity) {
        draw(matrices, x, y, width, height, radius, topLeft, topRight, bottomLeft, bottomRight, glowSize, glowIntensity, 1.0f);
    }
