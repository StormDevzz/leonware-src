...
/* JADX INFO: loaded from: leonware-0.0.3.jar:sweetie/leonware/api/utils/render/display/BlurRectRender.class */
public class BlurRectRender implements QuickImports {
    ...
    public void draw(class_4587 matrixStack, float x, float y, float width, float height, Vector4f radius, Color topLeft, Color topRight, Color bottomLeft, Color bottomRight, float mix) {
        ...
        builder.method_22918(matrix4f, adjustedX, adjustedY, 0.0f).method_22913(uLeft, vTop).method_39415(topLeft.getRGB());
        builder.method_22918(matrix4f, adjustedX, adjustedY + adjustedHeight, 0.0f).method_22913(uLeft, vBottom).method_39415(bottomLeft.getRGB());
        builder.method_22918(matrix4f, adjustedX + adjustedWidth, adjustedY + adjustedHeight, 0.0f).method_22913(uRight, vBottom).method_39415(bottomRight.getRGB());
        builder.method_22918(matrix4f, adjustedX + adjustedWidth, adjustedY, 0.0f).method_22913(uRight, vTop).method_39415(topRight.getRGB());
