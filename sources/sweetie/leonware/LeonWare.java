...
/* JADX INFO: loaded from: leonware-0.0.3.jar:sweetie/leonware/LeonWare.class */
public class LeonWare implements ClientModInitializer {
    ...
    public static Map<Module, Boolean> unhookSnapshot = new HashMap();
    ...
    public void postLoad() {
        ModuleManager.getInstance().getModules().sort((a, b) -> {
            return Float.compare(Fonts.PS_MEDIUM.getWidth(b.getName(), 7.0f), Fonts.PS_MEDIUM.getWidth(a.getName(), 7.0f));
        });
