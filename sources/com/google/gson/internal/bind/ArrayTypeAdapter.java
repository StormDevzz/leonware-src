...
/* JADX INFO: loaded from: leonware-0.0.3.jar:com/google/gson/internal/bind/ArrayTypeAdapter.class */
public final class ArrayTypeAdapter<E> extends TypeAdapter<Object> {
    public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.ArrayTypeAdapter.1
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
            ...
            TypeAdapter<T> arrayAdapter = new ArrayTypeAdapter<>(gson, gson.getAdapter(TypeToken.get(componentType)), C$Gson$Types.getRawType(componentType));
            return arrayAdapter;
        }
    };
    ...
    public Object read2(JsonReader in) throws IOException {
        ...
        return list.toArray((Object[]) Array.newInstance((Class<?>) this.componentType, size));
    }
