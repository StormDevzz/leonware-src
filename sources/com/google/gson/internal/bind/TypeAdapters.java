...
/* JADX INFO: loaded from: leonware-0.0.3.jar:com/google/gson/internal/bind/TypeAdapters.class */
public final class TypeAdapters {
    ...
    /* JADX INFO: loaded from: leonware-0.0.3.jar:com/google/gson/internal/bind/TypeAdapters$35.class */
    ...
    /* JADX INFO: loaded from: leonware-0.0.3.jar:com/google/gson/internal/bind/TypeAdapters$EnumTypeAdapter.class */
                ...
                for (Field field : (Field[]) AccessController.doPrivileged(new PrivilegedAction<Field[]>() { // from class: com.google.gson.internal.bind.TypeAdapters.EnumTypeAdapter.1
                    ...
                    if (serializedName != null) {
                        ...
                        for (String str : serializedName.alternate()) {
                            this.nameToConstant.put(str, (T) r0);
                        }
                    }
                    this.nameToConstant.put(strName, (T) r0);
                    this.stringToConstant.put(string, (T) r0);
                    this.constantToName.put((T) r0, strName);
                }
