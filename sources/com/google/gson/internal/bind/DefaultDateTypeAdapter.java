...
/* JADX INFO: loaded from: leonware-0.0.3.jar:com/google/gson/internal/bind/DefaultDateTypeAdapter.class */
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
    private static final String SIMPLE_NAME = "DefaultDateTypeAdapter";
    private final DateType<T> dateType;
    private final List<DateFormat> dateFormats;

    /* JADX INFO: loaded from: leonware-0.0.3.jar:com/google/gson/internal/bind/DefaultDateTypeAdapter$DateType.class */
