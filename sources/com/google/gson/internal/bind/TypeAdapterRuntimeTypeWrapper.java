...
/* JADX INFO: loaded from: leonware-0.0.3.jar:com/google/gson/internal/bind/TypeAdapterRuntimeTypeWrapper.class */
final class TypeAdapterRuntimeTypeWrapper<T> extends TypeAdapter<T> {
    ...
    public void write(JsonWriter out, T value) throws IOException {
        ...
        if (runtimeType != this.type) {
            ...
            if ((runtimeTypeAdapter instanceof ReflectiveTypeAdapterFactory.Adapter) && !isReflective(this.delegate)) {
