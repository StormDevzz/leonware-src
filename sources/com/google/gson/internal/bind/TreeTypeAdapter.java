...
/* JADX INFO: loaded from: leonware-0.0.3.jar:com/google/gson/internal/bind/TreeTypeAdapter.class */
public final class TreeTypeAdapter<T> extends SerializationDelegatingTypeAdapter<T> {
    ...
    /* JADX INFO: loaded from: leonware-0.0.3.jar:com/google/gson/internal/bind/TreeTypeAdapter$SingleTypeFactory.class */
    private static final class SingleTypeFactory implements TypeAdapterFactory {
        ...
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            ...
            if (this.exactType != null) {
                zIsAssignableFrom = this.exactType.equals(type) || (this.matchRawType && this.exactType.getType() == type.getRawType());
            } else {
                zIsAssignableFrom = this.hierarchyType.isAssignableFrom(type.getRawType());
            }
            boolean matches = zIsAssignableFrom;
            if (matches) {
    ...
    /* JADX INFO: loaded from: leonware-0.0.3.jar:com/google/gson/internal/bind/TreeTypeAdapter$GsonContextImpl.class */
