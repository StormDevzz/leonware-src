...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable
{
    ...
    public LinkedTreeMap(final boolean allowNullValues) {
        this((Comparator)LinkedTreeMap.NATURAL_ORDER, allowNullValues);
    }
    
    public LinkedTreeMap(final Comparator<? super K> comparator, final boolean allowNullValues) {
        this.size = 0;
        this.modCount = 0;
        this.comparator = (Comparator<? super K>)((comparator != null) ? comparator : LinkedTreeMap.NATURAL_ORDER);
        this.allowNullValues = allowNullValues;
        this.header = new Node<K, V>(allowNullValues);
    }
    ...
    Node<K, V> find(final K key, final boolean create) {
        ...
        int comparison = 0;
        if (nearest != null) {
            final Comparable<Object> comparableKey = (comparator == LinkedTreeMap.NATURAL_ORDER) ? ((Comparable)key) : null;
            while (true) {
