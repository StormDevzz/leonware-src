...
public class FeaturesData
{
    ...
    public FeaturesData(final float yawDelta, final float pitchDelta, final float targetYaw, final float targetPitch, final float sinceAttack, final float distance, final int onGround, final int miniHitbox, final float playerYaw, final float playerPitch, final float playerPosX, final float playerPosY, final float playerPosZ, final float playerVelX, final float playerVelY, final float playerVelZ, final float targetPosX, final float targetPosY, final float targetPosZ, final float targetVelX, final float targetVelY, final float targetVelZ, final float deltaX, final float deltaY, final float deltaZ) {
