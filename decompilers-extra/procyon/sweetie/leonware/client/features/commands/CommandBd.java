...
public class CommandBd extends Command
{
    ...
    public void execute(final LiteralArgumentBuilder<class_2172> builder) {
        builder.executes(context -> {
            ...
            double y = Math.round((float)(-CommandBd.mc.field_1724.method_17682() - CommandBd.mc.field_1724.method_23318() - 0.009999999776482582) * 100.0f) / 100.0;
            y += 0.15000000596046448;
            if (y > 0.0) {
                this.print("§c\u041d\u0435\u0432\u043e\u0437\u043c\u043e\u0436\u043d\u043e \u0442\u0435\u043b\u0435\u043f\u043e\u0440\u0442\u0438\u0440\u043e\u0432\u0430\u0442\u044c\u0441\u044f \u043f\u043e\u0434 \u0431\u0435\u0434\u0440\u043e\u043a!");
                return this.SINGLE_SUCCESS;
            }
            for (int packets = (int)Math.min(Math.abs(y / 10.0) + 1.0, 19.0), i = 0; i < packets; ++i) {
        ...
        builder.then(LiteralArgumentBuilder.literal("boat").executes(context -> {
            if (CommandBd.mc.field_1687 == null || CommandBd.mc.field_1724 == null) {
                this.print("§c\u041c\u0438\u0440 \u0438\u043b\u0438 \u0438\u0433\u0440\u043e\u043a \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d!");
                return this.SINGLE_SUCCESS;
            }
