...
public class StrictlyFriendArgument implements ArgumentType<String>
{
    ...
    public String parse(final StringReader reader) {
        ...
        if (!FriendManager.getInstance().contains(friend)) {
            try {
                throw new DynamicCommandExceptionType(name -> class_2561.method_43470("\u0414\u0440\u0443\u0433\u0430 \u0441 \u0438\u043c\u0435\u043d\u0435\u043c " + String.valueOf(name) + " \u043d\u0435 \u043d\u0430\u0439\u0434\u0435\u043d\u043e")).create((Object)friend);
            }
            catch (final CommandSyntaxException e) {
                throw new RuntimeException((Throwable)e);
            }
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(final CommandContext<S> context, final SuggestionsBuilder builder) {
        return class_2172.method_9265((Iterable)FriendManager.getInstance().getData(), builder);
    }
    
    public Collection<String> getExamples() {
        final List<String> examples = FriendManager.getInstance().getData().stream().limit(5L).collect((Collector<? super Object, ?, List<String>>)Collectors.toList());
