...
{
    private static final StrafeModule instance;
    private final ModeSetting mode;
    
    public StrafeModule() {
        this.mode = new ModeSetting("\u0420\u0435\u0436\u0438\u043c").values("\u041b\u0435\u0433\u0438\u0442\u043d\u044b\u0439", "MetaHvH", "Matrix7").value("\u041b\u0435\u0433\u0438\u0442\u043d\u044b\u0439");
        this.addSettings(this.mode);
    }
    
    @Override
    public void onEvent() {
        final EventListener rotationUpdateEvent = RotationUpdateEvent.getInstance().subscribe(new Listener<RotationUpdateEvent>(event -> {
        ...
        final EventListener movementInputEvent = MovementInputEvent.getInstance().subscribe(new Listener<MovementInputEvent.MovementInputEventData>(event -> {
            if (!this.mode.is("\u041b\u0435\u0433\u0438\u0442\u043d\u044b\u0439")) {
                ...
                final RotationPlan currentPlan = RotationManager.getInstance().getCurrentRotationPlan();
    ...
    private void handleMetaHvH() {
        ...
        if (!StrafeModule.mc.field_1724.method_6128() && MoveUtil.isMoving()) {
            float motion = 0.19f;
            final class_1293 speedEffect = StrafeModule.mc.field_1724.method_6112(class_1294.field_5904);
            if (speedEffect != null) {
                final int amplifier = speedEffect.method_5578();
                switch (amplifier) {
                    case 0: {
                        motion = 0.25f;
                        break;
    ...
    private void handleMatrix7() {
        if (MoveUtil.isMoving()) {
            if (StrafeModule.mc.field_1724.method_24828()) {
                ...
                final double motionSquared = StrafeModule.mc.field_1724.method_18798().field_1352 * StrafeModule.mc.field_1724.method_18798().field_1352 + StrafeModule.mc.field_1724.method_18798().field_1350 * StrafeModule.mc.field_1724.method_18798().field_1350;
    ...
    public static StrafeModule getInstance() {
        return StrafeModule.instance;
    }
    
    static {
        instance = new StrafeModule();
    }
}
