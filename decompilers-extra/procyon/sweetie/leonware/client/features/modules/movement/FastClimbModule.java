...
{
    private static final FastClimbModule instance;
    private final MultiBooleanSetting mode;
    private final SliderSetting ladderSpeed;
    
    public FastClimbModule() {
        this.mode = new MultiBooleanSetting("\u0420\u0435\u0436\u0438\u043c\u044b").value(new BooleanSetting("\u0421\u0442\u0443\u043f\u0435\u043d\u044c\u043a\u0438").value(true), new BooleanSetting("\u041b\u0435\u0441\u0442\u043d\u0438\u0446\u044b").value(true));
        this.ladderSpeed = new SliderSetting("\u0421\u043a\u043e\u0440\u043e\u0441\u0442\u044c \u043b\u0435\u0441\u0442\u043d\u0438\u0446").value(0.28f).range(0.15f, 0.6f).step(0.01f);
    ...
    private void handleLadder() {
        if (FastClimbModule.mc.field_1724.method_6101() && FastClimbModule.mc.field_1724.field_3913.method_3128().field_1342 > 0.01f) {
            FastClimbModule.mc.field_1724.method_18800(FastClimbModule.mc.field_1724.method_18798().field_1352, (double)this.ladderSpeed.getValue(), FastClimbModule.mc.field_1724.method_18798().field_1350);
        }
    }
    
    @Generated
    public static FastClimbModule getInstance() {
        return FastClimbModule.instance;
    }
    
    static {
        instance = new FastClimbModule();
    }
}
