...
public final class ClientInfo {
    ...
    public static final String VERSION = ((ModContainer)FabricLoader.getInstance().getModContainer("LeonWare".toLowerCase()).get()).getMetadata().getVersion().getFriendlyString();
