...
@CommandRegister(name="toggle")
public class CommandToggle
extends Command {
    @Override
    public void execute(LiteralArgumentBuilder<class_2172> builder) {
        builder.then(CommandToggle.argument("module", StringArgumentType.greedyString()).suggests((context, builder1) -> {
        ...
        builder.executes(context -> {
            this.print("\u00a76\u0418\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u0435: \u00a7ftoggle <\u043c\u043e\u0434\u0443\u043b\u044c>");
            return this.SINGLE_SUCCESS;
        });
    }
