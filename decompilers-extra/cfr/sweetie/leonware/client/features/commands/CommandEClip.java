...
public class CommandEClip
extends Command {
    @Override
    public void execute(LiteralArgumentBuilder<class_2172> builder) {
        builder.then(CommandEClip.literal("bedrock").executes(context -> {
            this.execute(-((float)CommandEClip.mc.field_1724.method_23318()) - 3.0f);
            return this.SINGLE_SUCCESS;
        }));
        builder.then(CommandEClip.literal("down").executes(context -> {
            float y = 0.0f;
            for (int i = 1; i < 255; ++i) {
                ...
                if (CommandEClip.mc.field_1687.method_8320(class_2338.method_49638((class_2374)CommandEClip.mc.field_1724.method_19538()).method_10069(0, -i, 0)) != class_2246.field_9987.method_9564()) continue;
        ...
        builder.then(CommandEClip.literal("up").executes(context -> {
            float y = 0.0f;
            for (int i = 4; i < 255; ++i) {
                if (CommandEClip.mc.field_1687.method_8320(class_2338.method_49638((class_2374)CommandEClip.mc.field_1724.method_19538()).method_10069(0, i, 0)) != class_2246.field_10124.method_9564()) continue;
                y = i + 1;
                break;
            }
            this.execute(y);
    ...
    private void execute(float y) {
        ...
        boolean bl = needSwap = elytraSlot != 6;
        if (needSwap) {
            syncId = CommandEClip.mc.field_1724.field_7512.field_7763;
        ...
        CommandEClip.mc.field_1724.field_3944.method_52787((class_2596)new class_2828.class_2829(CommandEClip.mc.field_1724.method_23317(), CommandEClip.mc.field_1724.method_23318() + (double)y, CommandEClip.mc.field_1724.method_23321(), false, CommandEClip.mc.field_1724.field_5976));
        CommandEClip.mc.field_1724.field_3944.method_52787((class_2596)new class_2848((class_1297)CommandEClip.mc.field_1724, class_2848.class_2849.field_12982));
        if (needSwap) {
            syncId = CommandEClip.mc.field_1724.field_7512.field_7763;
            CommandEClip.mc.field_1761.method_2906(syncId, 6, 1, class_1713.field_7790, (class_1657)CommandEClip.mc.field_1724);
        ...
        CommandEClip.mc.field_1724.method_5814(CommandEClip.mc.field_1724.method_23317(), CommandEClip.mc.field_1724.method_23318() + (double)y, CommandEClip.mc.field_1724.method_23321());
        this.print("\u00a7aElytra clip \u043d\u0430 " + String.format("%.1f", Float.valueOf(Math.abs(y))) + " \u0431\u043b\u043e\u043a\u043e\u0432.");
    }
    ...
    private int findElytraSlot() {
        ...
        for (int i = 0; i < 36; ++i) {
            if (CommandEClip.mc.field_1724.method_31548().method_5438(i).method_7909() != class_1802.field_8833) continue;
            return i < 9 ? i + 36 : i;
        }
        return -1;
    }
