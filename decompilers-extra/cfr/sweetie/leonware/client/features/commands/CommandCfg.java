...
extends Command {
    ...
    public void execute(LiteralArgumentBuilder<class_2172> builder) {
        builder.then(CommandCfg.literal("list").executes(context -> {
        ...
        builder.then(CommandCfg.literal("remove").then(CommandCfg.argument("config", StrictlyConfigNameArgument.create()).executes(context -> {
        ...
        builder.then(CommandCfg.literal("load").then(CommandCfg.argument("config", StrictlyConfigNameArgument.create()).executes(context -> {
            String config = StringArgumentType.getString((CommandContext)context, (String)"config");
        ...
        builder.then(CommandCfg.literal("save").then(CommandCfg.argument("config", AnyConfigNameArgument.create()).executes(context -> {
            String config = StringArgumentType.getString((CommandContext)context, (String)"config");
            ConfigManager.getInstance().save(config);
            this.print("\u0421\u043e\u0445\u0440\u0430\u043d\u0451\u043d \u043a\u043e\u043d\u0444\u0438\u0433: " + config);
            return this.SINGLE_SUCCESS;
        })));
        builder.then(CommandCfg.literal("folder").executes(context -> {
        ...
        builder.then(CommandCfg.literal("dir").executes(context -> {
            if (SharedClass.openFolder(ClientInfo.CONFIG_PATH_MAIN)) {
                this.print("\u041e\u0442\u043a\u0440\u044b\u0432\u0430\u044e...");
            } else {
                this.print("\u041d\u0435 \u0443\u0434\u0430\u043b\u043e\u0441\u044c \u043e\u0442\u043a\u0440\u044b\u0442\u044c \u043f\u0430\u043f\u043a\u0443 \u043a\u043e\u043d\u0444\u0438\u0433\u043e\u0432.");
