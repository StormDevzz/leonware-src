...
extends Module {
    ...
    public final BooleanSetting autoWalk = new BooleanSetting("Auto Walk").value(false);
    public final BooleanSetting exploit = new BooleanSetting("Exploit").value(false);
    ...
    private void onTick() {
        ...
        if (((Boolean)this.autoWalk.getValue()).booleanValue()) {
    ...
    private void handleNewLogic() {
        if (ElytraRecastModule.mc.field_1724.method_24828()) {
            this.groundTick = ((Float)this.groundDelay.getValue()).intValue();
            this.jump = 0;
            return;
        }
        if (this.groundTick > 0) {
