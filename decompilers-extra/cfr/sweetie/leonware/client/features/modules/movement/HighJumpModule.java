...
extends Module {
    ...
    private final SliderSetting vanillaHeight = new SliderSetting("\u0412\u044b\u0441\u043e\u0442\u0430 \u043f\u0440\u044b\u0436\u043a\u0430").value(Float.valueOf(0.6f)).range(0.1f, 2.0f).step(0.1f).setVisible(() -> this.mode.is("\u0412\u0430\u043d\u0438\u043b\u044c\u043d\u044b\u0439"));
    ...
    public void onEvent() {
        EventListener updateEvent = UpdateEvent.getInstance().subscribe(new Listener<UpdateEvent>(event -> {
            ...
            if (HighJumpModule.mc.field_1724.method_52535() || HighJumpModule.mc.field_1724.method_31549().field_7479 || HighJumpModule.mc.field_1724.method_3144()) {
                return;
            }
            if (this.mode.is("\u0412\u0430\u043d\u0438\u043b\u044c\u043d\u044b\u0439")) {
                if (HighJumpModule.mc.field_1690.field_1903.method_1434() && HighJumpModule.mc.field_1724.method_24828()) {
                    HighJumpModule.mc.field_1724.method_18800(HighJumpModule.mc.field_1724.method_18798().field_1352, (double)((Float)this.vanillaHeight.getValue()).floatValue(), HighJumpModule.mc.field_1724.method_18798().field_1350);
                }
            } else if (this.mode.is("\u0421\u043b\u0430\u0439\u043c")) {
                class_2338 playerPos = HighJumpModule.mc.field_1724.method_24515();
                ...
                if (HighJumpModule.mc.field_1690.field_1903.method_1434() && HighJumpModule.mc.field_1724.method_24828() && HighJumpModule.mc.field_1687.method_8320(belowPlayer).method_27852(class_2246.field_10030)) {
                    ...
                    if (this.jumpCounter >= 1) {
                        jumpVelocity = 0.6f;
                        if ((jumpVelocity += (float)(this.jumpCounter - 1) * 0.1f) > 1.1f) {
                            this.jumpCounter = 0;
                            jumpVelocity = 0.6f;
                        }
                    }
                ...
                class_2338 belowPos = HighJumpModule.mc.field_1724.method_24515().method_10074();
