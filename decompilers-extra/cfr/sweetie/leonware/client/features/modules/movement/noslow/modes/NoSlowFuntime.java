...
extends NoSlowMode {
    ...
    public void onUpdate() {
        ...
        int crossbowSlot = InventoryUtil.findItem(class_1802.field_8399);
        if (crossbowSlot == -1) {
            return;
        }
    ...
    private boolean isOnSnowLayer() {
        ...
        class_2338 below = NoSlowFuntime.mc.field_1724.method_24515().method_10074();
