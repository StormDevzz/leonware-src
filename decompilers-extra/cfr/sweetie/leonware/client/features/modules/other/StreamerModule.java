...
extends Module {
    ...
    private MultiBooleanSetting hide = new MultiBooleanSetting("Hides").value(new BooleanSetting[]{new BooleanSetting("Name").value(true), new BooleanSetting("Rainbow").value(true).setVisible(() -> this.getHide().isEnabled("Name")), new BooleanSetting("Hide friends").value(true).setVisible(() -> this.getHide().isEnabled("Name")), new BooleanSetting("No Fun Time").value(false)});
    ...
    public String generateProtectedFriendName(String originalName) {
        int id = this.friendCounter.computeIfAbsent(originalName.toLowerCase(), key -> this.globalCounter.getAndIncrement());
        return "\u0414\u0440\u0443\u0433 " + id;
    }

    public String getResourceKey() {
        String val;
        switch (val = (String)this.fakeDonate.getValue()) {
            case "\u0413\u0438\u0434\u0440\u0430": {
                return "hydra";
            }
            case "\u0426\u0435\u0440\u0431\u0435\u0440": {
