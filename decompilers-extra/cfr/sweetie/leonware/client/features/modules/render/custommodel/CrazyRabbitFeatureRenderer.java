...
public class CrazyRabbitFeatureRenderer
extends class_3887<class_10055, class_591> {
    private static final class_2960 RABBIT_TEXTURE = class_2960.method_60655((String)"leonware", (String)"textures/models/leon/rabbit.png");
    ...
    public void render(class_4587 matrices, class_4597 vertexConsumers, int light, class_10055 state, float limbAngle, float limbDistance) {
        ...
        class_4588 buffer = vertexConsumers.getBuffer(class_1921.method_23578((class_2960)RABBIT_TEXTURE));
