...
extends class_583<class_10055> {
    ...
    public static class_5607 createTexturedModelData() {
        ...
        class_5610 rabbitBone = root.method_32117("rabbit_bone", class_5606.method_32108().method_32101(28, 45).method_32098(-5.0f, -13.0f, -5.0f, 10.0f, 11.0f, 8.0f, new class_5605(0.0f)), class_5603.method_32090((float)0.0f, (float)24.0f, (float)0.0f));
        rabbitBone.method_32117("head", class_5606.method_32108().method_32101(0, 45).method_32098(-4.0f, -11.0f, -4.0f, 8.0f, 11.0f, 8.0f, new class_5605(0.0f)).method_32101(0, 0).method_32098(-3.0f, 0.0f, -4.0f, 6.0f, 1.0f, 6.0f, new class_5605(0.0f)).method_32101(56, 0).method_32098(-5.0f, -9.0f, -5.0f, 2.0f, 3.0f, 2.0f, new class_5605(0.0f)).method_32101(56, 0).method_32098(3.0f, -9.0f, -5.0f, 2.0f, 3.0f, 2.0f, new class_5605(0.0f)).method_32101(46, 0).method_32098(1.0f, -20.0f, 0.0f, 3.0f, 9.0f, 1.0f, new class_5605(0.0f)).method_32101(46, 0).method_32098(-4.0f, -20.0f, 0.0f, 3.0f, 9.0f, 1.0f, new class_5605(0.0f)), class_5603.method_32090((float)0.0f, (float)-14.0f, (float)-1.0f));
        rabbitBone.method_32117("left_arm", class_5606.method_32108().method_32101(0, 64).method_32098(0.0f, 0.0f, -2.0f, 2.0f, 8.0f, 4.0f, new class_5605(0.0f)), class_5603.method_32091((float)5.0f, (float)-13.0f, (float)-1.0f, (float)0.0f, (float)0.0f, (float)-0.0873f));
        rabbitBone.method_32117("right_arm", class_5606.method_32108().method_32101(0, 64).method_32098(-2.0f, 0.0f, -2.0f, 2.0f, 8.0f, 4.0f, new class_5605(0.0f)), class_5603.method_32091((float)-5.0f, (float)-13.0f, (float)-1.0f, (float)0.0f, (float)0.0f, (float)0.0873f));
        rabbitBone.method_32117("left_leg", class_5606.method_32108().method_32101(0, 74).method_32098(-2.0f, 0.0f, -2.0f, 4.0f, 2.0f, 4.0f, new class_5605(0.0f)), class_5603.method_32090((float)3.0f, (float)-2.0f, (float)-1.0f));
        rabbitBone.method_32117("right_leg", class_5606.method_32108().method_32101(0, 74).method_32098(-2.0f, 0.0f, -2.0f, 4.0f, 2.0f, 4.0f, new class_5605(0.0f)), class_5603.method_32090((float)-3.0f, (float)-2.0f, (float)-1.0f));
